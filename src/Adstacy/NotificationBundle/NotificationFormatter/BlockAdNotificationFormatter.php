...
class BlockAdNotificationFormatter implements NotificationFormatterInterface
{
    private $router;
    private $translator;
    private $formatter;
    ...
    {
        return $this->translator->trans('notification.block_ad');
    }

    public function support(Notification $notification)
    {
        return $notification->getType() == 'block_ad';
    }
}
