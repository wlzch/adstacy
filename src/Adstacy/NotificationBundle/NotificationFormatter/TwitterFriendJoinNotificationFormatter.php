...
class TwitterFriendJoinNotificationFormatter implements NotificationFormatterInterface
{
    private $router;
    private $translator;
    private $formatter;
    ...
    {
        return $this->translator->trans('notification.twitter_friend_join');
    }

    public function support(Notification $notification)
    {
        return $notification->getType() == 'twitter_friend_join';
    }
}
