...
class UnblockAdNotificationFormatter implements NotificationFormatterInterface
{
    private $router;
    private $translator;
    private $formatter;
    ...
    {
        return $this->translator->trans('notification.unblock_ad');
    }

    public function support(Notification $notification)
    {
        return $notification->getType() == 'unblock_ad';
    }
}
